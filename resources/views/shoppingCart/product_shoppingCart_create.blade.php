...
<section class="container m-5 dashboard d-flex justify-content-center">
    <div class="row m-0 p-0">
        <div class="col-12">
        <a class="btn btn-dark mb-5" href={{route('shoppingCart.index')}}>{{__('translation.shoppingCarts.create.back')}}</a> 
            <h2 class="font-weight-bold">@if($edit) {{__('translation.shoppingCarts.create.editShoppingCart')}} @else {{__('translation.shoppingCarts.create.addShoppingCart')}} @endif</h2>
